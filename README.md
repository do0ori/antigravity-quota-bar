...
[![Open VSX](https://img.shields.io/badge/Open%20VSX-v0.1.0-blue.svg)](https://open-vsx.org)
...
- **Exact 4-Group Quota Tracking**: Matches the official Antigravity IDE Settings screen (`Gemini Weekly/5-Hour` + `Claude & GPT Weekly/5-Hour`).
